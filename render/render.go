...
<body>
    ...
    <footer class="footer">
        <div class="container">
            <small><span class="text-muted">Dados <strong>públicos</strong>, disponibilizados pela Prefeitura de São Paulo conforme Decreto Nº 56.932, de 13 de abril de 2016 - <a href="http://www.docidadesp.imprensaoficial.com.br/NavegaEdicao.aspx?ClipID=7HI8B4N80T2FTeAVMBF9H6RKOA1&PalavraChave=56.932" target="_blank">Diário Oficial</a></span></small>
        </div>
    </footer>
